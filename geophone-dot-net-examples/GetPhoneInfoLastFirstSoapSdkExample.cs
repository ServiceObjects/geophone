...
{
    public static class GetPhoneInfoLastFirstSoapSdkExample
    {
        public static void Go(string LicenseKey, bool IsLive)
        {
            Console.WriteLine("\r\n-------------------------------------------");
            Console.WriteLine("GeoPhone - GetPhoneInfoLastFirst - SOAP SDK");
            Console.WriteLine("-------------------------------------------");
            ...
            GetPhoneInfoLastFirstValidation phoneInfoClient = new (IsLive);
            GPService.PhoneInfo response = phoneInfoClient.InvokeAsync("805-963-1700", LicenseKey).Result;
